...
export const BASE_URL = "https://api.gowild.appscorridor.com/api/vi/auth/login";
...
export const ENDPOINT = {
    ...
    card_user: {
        listing: `${API_URL}/cards`,
        update_image:`${API_URL}/cards`,
        delete: {
            url:`${API_URL}/cards/`,
        },
        add_user: `${API_URL}/cards`,
        edit_user: {
            url:`${API_URL}/cards/`,
        },
    },
    ...
    admin_guidelines :{
        ...
        add_faq : `${API_URL}/admin-guidelines`,
        delete_faq : `${API_URL}/admin-guidelines/`,
        update_faq : `${API_URL}/admin-guidelines/`,
